...
if (typeof L === 'undefined' || !document.getElementById('map')) {
    ...
    //           VARIABEL GLOBAL
    // ===============================================
    window.activeGeoJsonLayers = {};
    window.activeLegends = {};
    window.uploadedLayer = null;
    window.uploadedLayerLegend = null;
    window.featureRefMap = {};
    window.featureIdCounter = 0;
    ...
    // [PENTING] Matikan zoomControl default agar bisa kita pindah ke kanan
    ...
    document.addEventListener('click', function (event) {
        ...
        if (trigger) {
            ...
            if (fullUrl) window.openImageModal(fullUrl);
        }
    });
    ...
    if (imageModal) {
        imageModal.addEventListener('click', function (event) {
            if (event.target === imageModal) window.closeImageModal();
        });
    }
